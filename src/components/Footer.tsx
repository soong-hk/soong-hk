...
export default function Footer() {
  return (
    <footer
      className="mt-16 border-t py-8 px-4"
    ...
    >
      <div className="mx-auto max-w-4xl space-y-4 text-center">
        ...
        >
          ...
          本網站（鬆啲 soong.hk）所展示之影片及內容，均來自第三方製作人並僅供一般教育及參考用途。
          本站所提供之任何資訊，均<strong>不構成醫療建議</strong>，亦不能取代持牌醫療專業人士之診斷、治療或任何醫療服務。
          如您正在承受急性或嚴重疼痛，或患有任何醫療狀況，請在進行任何運動或伸展前，諮詢您的醫生或物理治療師。
          因使用本站資訊而引致之任何損傷或損失，本站概不負責。
        </div>
        ...
        <p className="text-xs" style={{ color: "var(--color-text-muted)" }}>
          ...
          <span className="mx-2">·</span>
          <a href="#" className="underline">使用條款</a>
        </p>
